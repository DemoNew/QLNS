...
namespace ThuctapNhom
{
    public partial class FormNhanVien : Form
    {
        ...
        private bool isEmpty()
        {
            ...
            {
                MessageBox.Show("B?n ch?a nh?p h? tên");
                return true;
            }
            if (!rdbnam.Checked && !rdbnu.Checked)
            {
                MessageBox.Show("B?n ch?a ch?n gi?i tính");
                return true;
            }
            if (txtquequan.Text.Trim() == "")
            {
                MessageBox.Show("B?n ch?a nh?p quê quán");
                return true;
            }
            ...
            {
                MessageBox.Show("B?n ch?a ch?n phòng ban");
                return true;
            }
        ...
        private void btnxoanv_Click(object sender, EventArgs e)
        {
            if(txtID.Text == "")
            {
                MessageBox.Show("B?n ch?a ch?n b?n ghi nào");
                return;
            }           
            try
            {
